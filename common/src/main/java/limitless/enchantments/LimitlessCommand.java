            ...
            .then(literal("blacklist").requires(source -> source.hasPermission(2)).
                ...
                .then(literal("add")
                    .then(argument("enchantment", ResourceArgument.resource(registryAccess, Registries.ENCHANTMENT))
                        .executes(context -> {
                            ...
                            if (!LimitlessEnchantments.blackListedEnchantments.contains(LimitlessEnchantments.registeredName(enchantment.value()))) {
                                LimitlessEnchantments.blackListedEnchantments.add(LimitlessEnchantments.registeredName(enchantment.value()));
                                context.getSource().sendSuccess(() -> Component.translatable("command.blacklist.blacklisted", LimitlessEnchantments.formattedName(enchantment.value())), true);
                            } 
                            else
                                context.getSource().sendSuccess(() -> Component.translatable("command.blacklist.already.blacklisted", LimitlessEnchantments.formattedName(enchantment.value())).setStyle(Style.EMPTY).withStyle(ChatFormatting.RED), true);
                ...
                .then(literal("remove")
                    .then(argument("enchantment", ResourceArgument.resource(registryAccess, Registries.ENCHANTMENT))
                        .executes(context -> {
                            ...
                            Reference<Enchantment> enchantment = ResourceArgument.getEnchantment(context, "enchantment");
                            if (LimitlessEnchantments.blackListedEnchantments.contains(LimitlessEnchantments.registeredName(enchantment.value()))) {
                                LimitlessEnchantments.blackListedEnchantments.remove(LimitlessEnchantments.registeredName(enchantment.value()));
                                context.getSource().sendSuccess(() -> Component.translatable("command.blacklist.removed", LimitlessEnchantments.formattedName(enchantment.value())), true);
                            } 
                            else
                                context.getSource().sendSuccess(() -> Component.translatable("command.blacklist.not_in", LimitlessEnchantments.formattedName(enchantment.value())).setStyle(Style.EMPTY.applyFormat(ChatFormatting.RED)), true);
                ...
                .then(literal("addAll")
                    .executes(context -> {
                        ...
                        try {
                            world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).forEach((e) -> {
                                Holder<Enchantment> entry = world.registryAccess().registryOrThrow(Registries.ENCHANTMENT).wrapAsHolder(e);
                                if (entry != null) {
                                    LimitlessEnchantments.blackListedEnchantments.add(LimitlessEnchantments.registeredName(entry.value()));
                                }
                            });
